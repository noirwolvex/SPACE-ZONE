          ...
          <div className="grid gap-0 lg:grid-cols-[1.1fr_0.9fr]">
            ...
            <div className="border-t border-slate-200 p-6 sm:p-8 lg:border-l lg:border-t-0 lg:p-10 dark:border-slate-800">
              ...
              <div className="mt-7 flex flex-wrap gap-3">
                <a href={site.websiteUrl} target="_blank" rel="noreferrer" className="rounded-full bg-slate-950 px-5 py-3 text-sm font-semibold text-white hover:bg-indigo-600">
                  Visit live website
                </a>
              </div>
            </div>
