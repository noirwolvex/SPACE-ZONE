        ...
        <div className="container mx-auto px-4 max-w-2xl relative z-10">
          ...
          <div className="bg-white dark:bg-slate-900/40 backdrop-blur-md p-8 md:p-10 rounded-2xl shadow-md dark:shadow-none border border-slate-200 dark:border-indigo-500/20">
            <div className="flex flex-col items-center justify-center py-12 text-center">
              ...
              <button 
                onClick={() => router.push(`/login?redirectTo=${encodeURIComponent("/contact")}`)}
                className="rounded-lg bg-indigo-600 px-6 py-3 text-sm font-bold text-white hover:bg-indigo-500 shadow-[0_4px_15px_rgba(79,70,229,0.3)] dark:shadow-[0_0_15px_rgba(79,70,229,0.4)] transition"
              >
                Sign In
              </button>
            </div>
        ...
        <div className="bg-white dark:bg-slate-900/40 backdrop-blur-md p-8 md:p-10 rounded-2xl shadow-md dark:shadow-none border border-slate-200 dark:border-indigo-500/20">
          {status === "success" ? (
            <div className="flex flex-col items-center justify-center py-10 text-center">
              ...
              <button onClick={() => setStatus("idle")} className="mt-8 text-indigo-600 dark:text-indigo-400 font-semibold hover:underline">
