        ...
        <div className="mx-auto flex max-w-7xl flex-wrap items-center gap-2">
          {links.map(([label, href], index) => (
            <Link
              ...
              className={
                index === 0
                  ? "group rounded-xl border border-indigo-200 bg-indigo-50 px-4 py-2 transition hover:border-indigo-400 hover:bg-indigo-100 dark:border-indigo-500/30 dark:bg-indigo-950/30 dark:hover:bg-indigo-950/50"
                  : "group rounded-xl border border-slate-200 bg-white px-4 py-2 transition hover:border-indigo-400 hover:bg-indigo-50 dark:border-indigo-500/30 dark:bg-slate-900 dark:hover:bg-indigo-950/40"
              }
            >
